                ...
                />
                {
                   (training.programmepdf ) ? 
                      <button type="button" onClick={toogleDownloadForm}
                        className="text-white w-full mt-4 mr-2 md:mr-0 md:mt-0 md:px-4 justify-center items-center uppercase py-3 rounded-lg relative border border-app-white hover:bg-white hover:text-app-blue"
                      >
